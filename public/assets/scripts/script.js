...
(() => {
  const dict = {
    en: {
      ...
      legal_s1_t: "Overview",
      legal_s1_p1: "This page brings together the legal information for the AquaSave website, deployed frontend app, and future connected device services. Some app flows currently preview the experience while backend and ESP32 integrations are completed.",
      legal_s1_p2: "By using AquaSave you accept the terms below. If you do not agree with any part of them, please stop using the service. These terms cover website visitors and people who use the app to create garden records, configure thresholds, review weather guidance, log watering activity, or later connect a device.",
      ...
      legal_s2_p4: "AquaSave is delivered on a best-effort basis. The current app may include frontend-only or beta flows while connected device features are being integrated. Treat app recommendations as decision support, not as a guarantee of physical watering.",
      ...
      legal_s4_l1: "<strong>Account data</strong>: username, email when provided, language preference, theme choice, and profile settings.",
      legal_s4_l2: "<strong>Garden and device records</strong>: garden names, locations, plant counts, plant types, descriptions, thresholds, schedules and device status shown in the app.",
      legal_s4_l3: "<strong>Watering and sensor-style data</strong>: soil moisture, temperature, weather context, pump tank values, watering events and manual history entries when entered or received.",
      ...
      legal_s4_p2: "We use this data to run the app experience, show dashboards, generate watering recommendations, prepare device setup flows, support users and improve irrigation logic. We never use garden or sensor data to build advertising profiles.",
      legal_s4_h3: "How long we keep it",
      legal_s4_p3: "During the frontend stage, much of the information may live locally or in test flows. Once remote services are enabled, account and device data will be kept only as long as needed to provide the service and meet legal obligations.",
      ...
      legal_s8_p1: "AquaSave is an aid for irrigation decisions, not a guarantee of plant outcomes. Frontend previews, sensor readings, weather forecasts and future device actions can be incomplete, delayed or wrong. Always check your garden and hardware when water stress matters.",
      ...
      legal_s12_p1: "Keeping your information safe is something we take seriously. The deployed frontend already separates user-facing flows from future service integrations, and production data services will apply security controls as backend features go live.",
      legal_s12_l1: "<strong>Secure transport</strong>: production connections between the app, services and device APIs should use encrypted channels.",
      legal_s12_l2: "<strong>Protected storage</strong>: sensitive account and device data will be protected when remote persistence is enabled.",
      legal_s12_l3: "<strong>Limited access</strong>: only authorized team members or services should access operational data needed to support AquaSave.",
      legal_s12_l4: "<strong>Recovery practices</strong>: production backend services will include backup and recovery procedures appropriate for the data stored.",
      ...
      legal_s14_l1: "<strong>Hosting &amp; infrastructure</strong>: cloud providers host the website and app and will support backend services when enabled.",
      legal_s14_l2: "<strong>Authentication and messaging</strong>: services may help with account access, password recovery and service notifications when those features are connected.",
      legal_s14_l3: "<strong>Payments</strong>: if paid plans are introduced, PCI-compliant processors will handle payment details.",
      legal_s14_l4: "<strong>Weather and location data</strong>: forecast and geocoding providers help the app show local weather and irrigation guidance.",
      ...
      legal_s15_p1: "Some AquaSave features may appear as beta, preview or frontend-only flows while backend, firmware and ESP32 connectivity are completed. These features help validate the experience before full release.",
      legal_s15_l1: "Preview features may simulate a flow, change their interface, or be replaced as the connected service evolves.",
      legal_s15_l2: "We may collect feedback or limited diagnostics to understand whether the app flow is clear and reliable.",
      legal_s15_l3: "Preview features do not guarantee physical irrigation or remote persistence until the related backend and device integrations are active.",
      ...
      legal_s16_p1: "Paid plans are not active in the current frontend release. This section explains how billing would work if AquaSave introduces subscriptions later.",
      legal_s16_h1: "Current access",
      legal_s16_p2: "The deployed app can be opened for the current frontend experience. Any pricing or plan references are informational until backend and payment services are enabled.",
    ...
    es: {
      ...
      legal_s1_t: "Resumen",
      legal_s1_p1: "Esta página reúne la información legal del sitio web de AquaSave, la app frontend desplegada y los futuros servicios conectados al dispositivo. Algunos flujos de la app actualmente muestran la experiencia mientras se completa la integración con backend y ESP32.",
      legal_s1_p2: "Al usar AquaSave aceptas los términos siguientes. Si no estás de acuerdo con alguna parte, deja de usar el servicio. Estos términos cubren a visitantes del sitio y a personas que usan la app para crear huertos, configurar umbrales, revisar clima, registrar riegos o conectar un dispositivo más adelante.",
      ...
      legal_s2_p4: "AquaSave se ofrece bajo el principio de mejor esfuerzo. La app actual puede incluir flujos solo frontend o beta mientras se integran las funciones conectadas al dispositivo. Toma las recomendaciones como apoyo para decidir, no como garantía de riego físico.",
      ...
      legal_s4_l1: "<strong>Datos de cuenta</strong>: usuario, correo cuando se proporcione, idioma preferido, tema visual y configuración de perfil.",
      legal_s4_l2: "<strong>Registros de huerto y dispositivo</strong>: nombres de huerto, ubicaciones, cantidad de plantas, tipos de planta, descripciones, umbrales, horarios y estado mostrado del dispositivo.",
      legal_s4_l3: "<strong>Datos de riego y sensores simulados o conectados</strong>: humedad del suelo, temperatura, contexto climático, depósito de bomba, eventos de riego e historial manual cuando se ingresen o reciban.",
      ...
      legal_s4_p2: "Usamos estos datos para ejecutar la experiencia de app, mostrar dashboards, generar recomendaciones de riego, preparar flujos de configuración de dispositivo, dar soporte y mejorar la lógica de irrigación. Nunca usamos datos de huertos o sensores para crear perfiles publicitarios.",
      legal_s4_h3: "Cuánto tiempo los guardamos",
      legal_s4_p3: "Durante la etapa frontend, gran parte de la información puede vivir localmente o en flujos de prueba. Cuando los servicios remotos estén habilitados, los datos de cuenta y dispositivo se conservarán solo el tiempo necesario para prestar el servicio y cumplir obligaciones legales.",
      ...
      legal_s8_t: "Aviso",
      legal_s8_p1: "AquaSave es una ayuda para tomar decisiones de riego, no una garantía de resultado para tus plantas. Las vistas frontend, lecturas de sensores, pronósticos y futuras acciones de dispositivo pueden estar incompletas, demorarse o equivocarse. Revisa siempre tu huerto y hardware cuando el estrés hídrico sea importante.",
      ...
      legal_s12_p1: "Mantener tu información segura es algo que nos tomamos en serio. El frontend desplegado separa los flujos visibles de las futuras integraciones de servicio, y los servicios productivos aplicarán controles de seguridad cuando las funciones backend entren en operación.",
      legal_s12_l1: "<strong>Transporte seguro</strong>: las conexiones productivas entre la app, servicios y APIs del dispositivo deberán usar canales cifrados.",
      legal_s12_l2: "<strong>Almacenamiento protegido</strong>: los datos sensibles de cuenta y dispositivo se protegerán cuando la persistencia remota esté habilitada.",
      legal_s12_l3: "<strong>Acceso limitado</strong>: solo integrantes o servicios autorizados deberán acceder a los datos operativos necesarios para dar soporte a AquaSave.",
      legal_s12_l4: "<strong>Prácticas de recuperación</strong>: los servicios backend productivos incluirán copias y recuperación apropiadas para los datos almacenados.",
      ...
      legal_s14_l1: "<strong>Hosting e infraestructura</strong>: proveedores cloud alojan el sitio y la app, y soportarán servicios backend cuando estén habilitados.",
      legal_s14_l2: "<strong>Autenticación y mensajería</strong>: algunos servicios podrán apoyar el acceso a cuenta, recuperación de contraseña y notificaciones cuando esas funciones se conecten.",
      legal_s14_l3: "<strong>Pagos</strong>: si se introducen planes pagados, procesadores con cumplimiento PCI manejarán los datos de pago.",
      legal_s14_l4: "<strong>Clima y ubicación</strong>: proveedores de pronóstico y geocodificación ayudan a mostrar clima local y recomendaciones de riego.",
      ...
      legal_s15_p1: "Algunas funciones de AquaSave pueden aparecer como beta, vista previa o flujo solo frontend mientras se completa backend, firmware y conectividad ESP32. Estas funciones ayudan a validar la experiencia antes del lanzamiento completo.",
      legal_s15_l1: "Las funciones de vista previa pueden simular un flujo, cambiar su interfaz o ser reemplazadas conforme evolucione el servicio conectado.",
      legal_s15_l2: "Podemos recopilar feedback o diagnósticos limitados para entender si el flujo de app es claro y confiable.",
      legal_s15_l3: "Las funciones de vista previa no garantizan riego físico ni persistencia remota hasta que las integraciones backend y de dispositivo estén activas.",
      ...
      legal_s16_p1: "Los planes pagados no están activos en la versión frontend actual. Esta sección explica cómo funcionaría la facturación si AquaSave introduce suscripciones más adelante.",
      legal_s16_h1: "Acceso actual",
      legal_s16_p2: "La app desplegada puede abrirse para probar la experiencia frontend actual. Cualquier referencia a precios o planes es informativa hasta que backend y pagos estén habilitados.",
